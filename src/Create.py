...
#        path_db_accounts = os.path.join(self.db_dir_path, "GitHub.Accounts.sqlite3")
#        subprocess.call(shlex.split("bash ./account/Run.sh \"{0}\"".format(db_path)))
...
#        subprocess.call(shlex.split("bash ./gnu_license/create/Create.sh \"{0}\"".format(db_path)))
    ...
    def __Setup(self):
        ...
        self.path_db_license = '/media/{0}/{1}/{2}/private/v0/GitHub.Licenses.sqlite3'.format(os_user_name, device_name, path_db_base)
